	...
	info:{
		init:function(){
			$('.play-list .play').each(function(){
				...
				album=album?'<span class="album">'+album+'</span>':'Anime desconhecido';
				albumart=albumart?'<img src="'+albumart+'">':'';
				artist=artist?'<span class="song-artist">'+artist+'</span>':'Artista desconhecido';
				title=title?'<div class="song-title">'+title+'</div>':'Título desconhecido';
		...
		load:function(id,album,artist,title,albumart,mp3){
			...
			albumart=albumart?'<img src="'+albumart+'">':''; 
			album=album?album:'Anime desconhecido';
			title=title?title:'Título desconhecido';
			artist=artist?artist:'Artista desconhecido';
